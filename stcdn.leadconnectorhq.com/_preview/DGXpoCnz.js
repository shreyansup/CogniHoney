...
const Lr = "v2_history",
    ...
    Nr = "v2_user_session_event_",
    Pr = "v3_first_session_event_";
...
function Ne(e) {
    return C(e) ? Fe(e) : _e(e)
}

function Pe(e) {
    return function(r) {
        r = i(r);
        var n = C(r) ? Ne(r) : void 0,
            t = n ? n[0] : r.charAt(0),
            u = n ? be(n, 1).join("") : r.slice(1);
        return t[e]() + u
    }
}
var ze = Pe("toUpperCase");
...
var w = "\\ud800-\\udfff",
    ...
    R = "(?:" + z + "|" + B + ")",
    Rr = "(?:" + a + "|" + B + ")",
    y = "(?:" + N + "(?:d|ll|m|re|s|t|ve))?",
    S = "(?:" + N + "(?:D|LL|M|RE|S|T|VE))?",
    D = pr + "?",
    H = "[" + dr + "]?",
    ...
    hr = H + D + yr,
    _r = "(?:" + [xr, Z, k].join("|") + ")" + hr,
    Or = RegExp([a + "?" + z + "+" + y + "(?=" + [m, a, "$"].join("|") + ")", Rr + "+" + S + "(?=" + [m, a + R, "$"].join("|") + ")", a + "?" + R + "+" + y, a + "+" + S, vr, Sr, P, _r].join("|"), "g");
...
export {
    V as A, Kr as B, h as C, K as D, Vr as E, zr as F, Qr as G, Lr as H, Jr as I, Wr as J, f as S, Fr as U, de as a, le as b, fe as c, ae as d, O as e, Br as f, qr as g, C as h, ie as i, be as j, jr as k, Yr as l, W as m, Hr as n, Gr as o, Dr as p, Pr as q, Mr as r, Ne as s, i as t, Nr as u, Zr as v, kr as w, Q as x, v as y, $r as z
};