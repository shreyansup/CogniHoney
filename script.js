/* ============================================
CogniHoney™ — Main JavaScript (SlimTide structure)
============================================ */
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* Scroll Reveal */
  var reveals = document.querySelectorAll('.mech-card, .ing-card, .ben-card, .review-card, .price-card, .bonus-card, .why-card');
